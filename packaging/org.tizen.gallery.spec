...
cmake . -DCMAKE_INSTALL_PREFIX=%{_appdir}/org.tizen.gallery  -DCMAKE_DATA_DIR=%{_datadir} -DARCH=%{ARCH} -DCMAKE_APP_ICON_DIR=%{_app_icon_dir} -DCMAKE_APP_SHARE_PACKAGES_DIR=%{_app_share_packages_dir}
